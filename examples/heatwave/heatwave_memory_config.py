...
def memory_config_societyagent_heatwave(
    distributions: dict[str, Distribution],
) -> tuple[dict[str, MemoryT], dict[str, MemoryT], dict[str, Any]]:
    if not hasattr(memory_config_societyagent_heatwave, "profile_list"):
        with open("profiles_with_aoi.json", "r") as f:
            setattr(memory_config_societyagent_heatwave, "profile_list", json.load(f))
    profile_list = getattr(memory_config_societyagent_heatwave, "profile_list")
